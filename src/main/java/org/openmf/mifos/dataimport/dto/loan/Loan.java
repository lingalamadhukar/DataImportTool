...
public class Loan {
    ...
    private final List<TrancheDetail> disbursementData;
    ...
    public Loan(String loanType, String clientId, String productId, String loanOfficerId, String submittedOnDate, String fundId,
            ...
            String repaymentsStartingFromDate, Integer rowIndex, String status, String externalId, String groupId, List<Charge> charges,
            String linkAccountId, String fixedEmiAmount, String maxOutstandingLoanBalance, List<TrancheDetail> disbursementData) {
    ...
    public List<TrancheDetail> getDisbursementData() {
