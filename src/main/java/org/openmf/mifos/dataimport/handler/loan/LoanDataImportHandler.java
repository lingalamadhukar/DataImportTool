...
import org.openmf.mifos.dataimport.dto.loan.TrancheDetail;
...
public class LoanDataImportHandler extends AbstractDataImportHandler {
    ...
    private static final int FIXED_EMI_AMOUNT_COL = 45;
    private static final int MAX_OUTSTANDING_LOAN_BALANCE_COL = 46;
    private static final int EMI_EXPECTED_DISBURSAL_DATE_COL = 47;
    private static final int EMI_PRINCIPAL_COL = 48;
    ...
    private Loan parseAsLoan(final Row row) {
        ...
        final List<TrancheDetail> disbursementData = new ArrayList<TrancheDetail>(1);
        ...
        final TrancheDetail trancheDetail = new TrancheDetail(emiExpectedDisbursementDate, emiPrincipal);
        disbursementData.add(trancheDetail);
        ...
        if (loanType.equals("individual")) {
            ...
            return new Loan(loanType, clientId, productId, loanOfficerId, submittedOnDate, fundId, principal, numberOfRepayments,
                    ...
                    row.getRowNum(), status, externalId, null, charges, linkAccountId, fixedEmiAmount, maxOutstandingLoanBalance,
                    disbursementData);
            ...
            return new Loan(loanType, clientId, productId, loanOfficerId, submittedOnDate, fundId, principal, numberOfRepayments,
                    ...
                    amortizationId, interestMethodId, interestCalculationPeriodId, arrearsTolerance, repaymentStrategyId,
                    graceOnPrincipalPayment, graceOnInterestPayment, graceOnInterestCharged, interestChargedFromDate, firstRepaymentOnDate,
                    row.getRowNum(), status, externalId, groupId, charges, linkAccountId, fixedEmiAmount, maxOutstandingLoanBalance,
                    disbursementData);
        } else {
            ...
            return new GroupLoan(loanType, groupIdforGroupLoan, productId, loanOfficerId, submittedOnDate, fundId, principal,
                    ...
                    graceOnPrincipalPayment, graceOnInterestPayment, graceOnInterestCharged, interestChargedFromDate, firstRepaymentOnDate,
                    row.getRowNum(), status, externalId, linkAccountId, fixedEmiAmount, maxOutstandingLoanBalance, disbursementData);
        }
